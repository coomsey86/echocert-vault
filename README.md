# EchoCert Vault (v0.1.0)
Portable, tamper-evident evidence bundles for AI-assisted decisions.

CLI:
- echocert-vault init
- echocert-vault record
- echocert-vault decide
- echocert-vault export
- echocert-vault verify
